...
<div class="single-product-gallery-item" id="slide{{$img->id}}">
    <a data-lightbox="image-1" data-title="Gallery" href="{{asset('storage/upload/product/image/'.$img->photo_name)}}">
        <img class="img-responsive" alt="" src="{{asset('storage/upload/product/image/'.$img->photo_name)}}"
            data-echo="{{asset('storage/upload/product/image/'.$img->photo_name)}}" />
    </a>
...
<div id="owl-single-product-thumbnails">
    ...
    <div class="item">
        <a class="horizontal-thumb" data-target="#owl-single-product" data-slide="1" href="#slide{{$img->id}}">
            ...
            src="{{asset('storage/upload/product/image/'.$img->photo_name)}}" 
            data-echo="{{asset('storage/upload/product/image/'.$img->photo_name)}}" />
        </a>
    </div>
    @endforeach
