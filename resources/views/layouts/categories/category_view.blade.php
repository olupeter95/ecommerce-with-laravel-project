  ...
  <div class="container">
    <div class="breadcrumb-inner">
      <ul class="list-inline list-unstyled">
        ...
        <li class='active'>{{ $cat->category_name_en }}</li>
      </ul>
    </div>
    <!-- /.breadcrumb-inner --> 
  </div>
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          <div class="image"> <a href="{{route('product-details',$prods->id)}}">
                            <img  src="{{asset('storage/upload/product/thumbnail/'.$prods->product_thumbnail)}}" alt=""></a> </div>
                          <!-- /.image -->
