  ...
  <table width="100%" style="background: #F7F7F7; padding:0 20px 0 20px;">
    <tr>
        <td valign="top">
          ...
          <h2 style="color: green; font-size: 26px;"><strong>Lacime Fashion Store</strong></h2>
        </td>
        <td align="right">
            <pre class="font" >
               Lacime Fashion Store Head Office
               Email:adekemiadekunle142@gmail.com <br>
               Mob: 08137163160 <br>
               14 Destiny Street, Ibadan <br>
        ...
        <td>
          <p class="font" style="margin-left: 20px;">
           ...
           <strong>Phone:</strong> {{$order->phone}} <br>
            @php
                $div = $order->division->divison_name;
    ...
    @foreach($orderItem as $item)
      <tr class="font">
        <td align="center">
            ...
            <img src="{{ public_path('storage/upload/product/thumbnail/'.$item->product->product_thumbnail) }} " height="60px;" width="60px;" alt="">
        </td>
