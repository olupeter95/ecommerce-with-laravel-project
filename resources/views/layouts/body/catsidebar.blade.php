          ...
          <li class="dropdown menu-item"> 
            ...
            <ul class="dropdown-menu mega-menu">
              <li class="yamm-content">
                <div class="row">
                @php
                $subcategories = App\Models\SubCategory::Where('category_id',$cat->id)->orderBy(
                ...
                @foreach($subcategories as $subcat)
                  <div class="col-sm-12 col-md-3">
                    ...
                    @php
                    $subsubcategories = App\Models\SubSubCategory::Where('subcategory_id',$subcat->id)->orderBy(
