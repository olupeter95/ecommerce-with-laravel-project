...
<div class="box box-widget widget-user">
					...
					<div class="widget-user-header bg-black" style="background: url({{asset('images/gallery/full/10.jpg')}}) center center;">
					  ...
					  <a href="{{ route('admin.profile.edit',$admin->id) }}" style="float:right" class="btn btn-rounded btn-success mb-5">Edit profile</a>
					</div>
					<div class="widget-user-image">
					  <img class="rounded-circle" src="{{ (!empty($admin->profile_photo_path)) ? 
